...
namespace PoeBot.Core.Models
{
    ...
    public partial class CurrenciesJson
    {
        public static CurrenciesJson FromJson(string json) => JsonConvert.DeserializeObject<CurrenciesJson>(json, PoeBot.Core.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this CurrenciesJson self) => JsonConvert.SerializeObject(self, PoeBot.Core.Models.Converter.Settings);
    }
