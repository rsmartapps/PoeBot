...
namespace PoeBot.Core.Models.Maps
{
    using System;
    ...
    public partial class MapsJson
    {
        public static MapsJson FromJson(string json) => JsonConvert.DeserializeObject<MapsJson>(json, PoeBot.Core.Models.Maps.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this MapsJson self) => JsonConvert.SerializeObject(self, PoeBot.Core.Models.Maps.Converter.Settings);
    }
