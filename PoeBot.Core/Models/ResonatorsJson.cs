...
namespace PoeBot.Core.Models.Resonators
{
    using System;
    ...
    public partial class ResonatorsJson
    {
        public static ResonatorsJson FromJson(string json) => JsonConvert.DeserializeObject<ResonatorsJson>(json, PoeBot.Core.Models.Resonators.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ResonatorsJson self) => JsonConvert.SerializeObject(self, PoeBot.Core.Models.Resonators.Converter.Settings);
    }
